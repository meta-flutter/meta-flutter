...
# UNPACKDIR arrived long after dunfell, where fetches land directly in
# WORKDIR. Master's "${UNPACKDIR}/gn" expands to nothing here and do_unpack
# rejects the result.
S = "${WORKDIR}/gn"
...
# -Wno-nontrivial-memcall, which arrived in clang 20; meta-clang carries 14 on
# dunfell-clang14, so an external clang fails the build outright under -Werror.
