...
SUMMARY = "android_intent_example"
...
PUBSPEC_APPNAME = "android_intent_example"
FLUTTER_APPLICATION_INSTALL_SUFFIX = "fluttercommunity-plus-plugins-packages-android-intent-plus-example"
FLUTTER_APPLICATION_PATH = "packages/android_intent_plus/example"
