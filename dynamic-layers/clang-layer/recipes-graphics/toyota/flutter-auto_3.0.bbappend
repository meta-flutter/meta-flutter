...
# master those come from openembedded-core, which now carries clang; this
# release's openembedded-core predates that move, so they are meta-clang's to
# provide and belong here. A dependency the recipe cannot satisfy without this
# layer stops it parsing at all, rather than merely building differently.
#
